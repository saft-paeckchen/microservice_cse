...
const (
	SearchService_SearchedProducts_FullMethodName = "/hipstershop.SearchService/SearchedProducts"
)
...
type SearchServiceClient interface {
	SearchedProducts(ctx context.Context, in *SearchedRequest, opts ...grpc.CallOption) (*SearchedResponse, error)
}
...
func (c *searchServiceClient) SearchedProducts(ctx context.Context, in *SearchedRequest, opts ...grpc.CallOption) (*SearchedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchedResponse)
	err := c.cc.Invoke(ctx, SearchService_SearchedProducts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearchServiceServer interface {
	SearchedProducts(context.Context, *SearchedRequest) (*SearchedResponse, error)
...
func (UnimplementedSearchServiceServer) SearchedProducts(context.Context, *SearchedRequest) (*SearchedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchedProducts not implemented")
}
...
func _SearchService_SearchedProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SearchServiceServer).SearchedProducts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SearchService_SearchedProducts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).SearchedProducts(ctx, req.(*SearchedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SearchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hipstershop.SearchService",
	HandlerType: (*SearchServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SearchedProducts",
			Handler:    _SearchService_SearchedProducts_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
