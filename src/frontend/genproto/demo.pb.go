...
func (x *SearchedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchedRequest) ProtoMessage() {}

func (x *SearchedRequest) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchedRequest.ProtoReflect.Descriptor instead.
func (*SearchedRequest) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{32}
}

func (x *SearchedRequest) GetQuery() string {
	if x != nil {
		return x.Query
	}
	return ""
...
func (x *SearchedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchedResponse) ProtoMessage() {}

func (x *SearchedResponse) ProtoReflect() protoreflect.Message {
	mi := &file_demo_proto_msgTypes[33]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchedResponse.ProtoReflect.Descriptor instead.
func (*SearchedResponse) Descriptor() ([]byte, []int) {
	return file_demo_proto_rawDescGZIP(), []int{33}
}

func (x *SearchedResponse) GetProducts() []*Product {
	if x != nil {
		return x.Products
	}
	return nil
...
const file_demo_proto_rawDesc = "" +
	...
	"\x0fSearchedRequest\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\"D\n" +
	"\x10SearchedResponse\x120\n" +
	"\bproducts\x18\x01 \x03(\v2\x14.hipstershop.ProductR\bproducts2\xca\x01\n" +
	"\vCartService\x12<\n" +
	...
	"\tAdService\x12;\n" +
	"\x06GetAds\x12\x16.hipstershop.AdRequest\x1a\x17.hipstershop.AdResponse\"\x002b\n" +
	"\rSearchService\x12Q\n" +
	"\x10SearchedProducts\x12\x1c.hipstershop.SearchedRequest\x1a\x1d.hipstershop.SearchedResponse\"\x00B?Z=github.com/GoogleCloudPlatform/microservices-demo/hipstershopb\x06proto3"
...
var file_demo_proto_goTypes = []any{
	...
	(*SearchedRequest)(nil),                // 32: hipstershop.SearchedRequest
	(*SearchedResponse)(nil),               // 33: hipstershop.SearchedResponse
}
var file_demo_proto_depIdxs = []int32{
	...
	8,  // 23: hipstershop.SearchedResponse.products:type_name -> hipstershop.Product
	...
	32, // 39: hipstershop.SearchService.SearchedProducts:input_type -> hipstershop.SearchedRequest
	...
	33, // 55: hipstershop.SearchService.SearchedProducts:output_type -> hipstershop.SearchedResponse
